...
public class ContactCreationTest {
    ...
    public void ContactCreationTest() {
        ...
        wd.findElement(By.name("nickname")).sendKeys("IvanPetrov");
        wd.findElement(By.name("title")).click();
        wd.findElement(By.name("title")).clear();
        wd.findElement(By.name("title")).sendKeys();
        wd.findElement(By.name("title")).click();
        wd.findElement(By.name("title")).clear();
        wd.findElement(By.name("title")).sendKeys("Разработчик");
        wd.findElement(By.name("company")).click();
        wd.findElement(By.name("company")).clear();
        wd.findElement(By.name("company")).sendKeys("Сайнер");
        wd.findElement(By.name("address")).click();
        wd.findElement(By.name("address")).clear();
        wd.findElement(By.name("address")).sendKeys("Г.Белгород, улица Харьковский переулок 36 д");
        wd.findElement(By.name("home")).click();
        wd.findElement(By.name("home")).click();
        wd.findElement(By.name("home")).clear();
        wd.findElement(By.name("home")).sendKeys("703 698 56 32");
        new Actions(wd).doubleClick(wd.findElement(By.name("mobile"))).build().perform();
